# 👩‍💻 Hello mundo! I'm Salma Fithi 👩‍💻

![Animated Girl Coding](https://media1.tenor.com/m/f440ySfSBfQAAAAC/takane-lui-hacker-man.gif)

Welcome to my coding wonderland! I'm a passionate software engineer with a knack for networking and a flair for coding. 💻✨

## 🚀 About Me

- 🌐 Networking enthusiast with a solid foundation in Python, C, Data Structures, and Algorithms.
- 📚 Currently diving into the world of front-end and back-end technologies.
- 💡 Excited to learn HTML, CSS, JavaScript, PHP, SQL, Ruby, Java, Swift, Kotlin, Go, C++, MATLAB, Objective C, ASP, Assembler.
- 🎓 Always curious and ready to explore new technologies to enhance my coding repertoire.
